...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"fade",prev:"",next:"",duration:20*100,delay:20*100,width:900,height:400,autoPlay:true,autoPlayVideo:false,playPause:false,stopOnHover:false,loop:false,bullets:true,caption:false,captionEffect:"parallax",controls:true,responsive:1,fullScreen:false,onBeforeStep:0,images:[{src:"./slide.jpg",title:"slide"},{src:"./slide1.jpg",title:"slide1"},{src:"./slide2.jpg",title:"slide2"},{src:"./slide3.jpg",title:"slide3"},{src:"./slide4.jpg",title:"slide4"},{src:"./slide5.jpg",title:"slide5"}]});